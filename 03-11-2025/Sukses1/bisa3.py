...
# --- Fungsi extract_text_with_metadata, preprocess_text, dan process_data_normal_semantic_chunking ---
# --- Tidak ada perubahan di ketiga fungsi ini, jadi saya salin dari kode sebelumnya ---
    ...
    for pdf_name in tqdm(pdf_files, desc="Memproses semua PDF", unit="file"):
        ...
        if final_chunks:
            ...
            for c in final_chunks:
                ...
                # ChromaDB tidak bisa menerima list. Ubah list skor menjadi string tunggal.
            ...
            try:
                collection.add(
                    ...
                    metadatas=metadatas, # Sekarang 'metadatas' sudah berisi tipe data yang aman
                    ids=ids
                )
