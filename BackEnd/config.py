...
EXCEL_OUTPUT_FILENAME = "CB_0.4.xlsx"
DOCUMENT_PROMPT_TEMPLATE = "Rentang: {source_range}\nKonten: {page_content}\n---"
PROMPT_TEMPLATE = """Anda adalah asisten cerdas tanya Alkitab Jika diluar alkitab katakan tidak tahu. Anda mampu menjawab pertanyaan seputar alkitab saja dari konteks yang diberikan Alkitab dan riwayat percakapan.
