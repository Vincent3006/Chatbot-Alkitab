...
EVAL_OUTPUT_PATH = "evaluation_results_3.xlsx" 
RETRIEVAL_K = 4
...
def calculate_metrics(retrieved_chunks: list, expected_chunks: list):
    """
    Menghitung metrik Precision@k, Recall@k, dan Reciprocal Rank untuk.
    """
...
def main():
    ...
    try:
        ...
        print(f"\nHasil evaluasi telah disimpan di '{os.path.abspath(EVAL_OUTPUT_PATH)}'")
    except Exception as e:
